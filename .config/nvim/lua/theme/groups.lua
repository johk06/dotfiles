--[[ Information {{{
This module is required anew each time the 'background' option changes,
so it will be required a maximum of two times: once for light and once for dark colors
}}} ]]
...
add_with_prefix(colorscheme, "@", {
    ...
    ["markup.link.label"]            = { fg = col.blue, underline = true, italic = true, nocombine = true },
...
add_with_prefix(colorscheme, "File", {
    ...
    TimeLastWeek      = { fg = col.teal },
    TimeLastFortnight = { fg = col.light_blue },
    TimeLastMonth     = { fg = col.blue },
    TimeLastYear      = { fg = col.purple },
    TimeOld           = { fg = col.bright_gray },

    -- Pretty much the same for file sizes
    SizeNone          = { fg = col.bright_gray },
    SizeNormal        = { fg = pal.fg2 },
    SizeMedium        = { fg = col.green },
...
add_with_prefix(colorscheme, "Oil", {
    ...
    User             = { fg = col.bright_gray, italic = true },
    Group            = { fg = col.blue, italic = true },
...
add_with_prefix(colorscheme, "BlinkCmp", {
    ...
    KindFolder          = { fg = col.teal },
    KindFunction        = { fg = col.light_blue },
...
add_with_prefix(colorscheme, "Telescope", {
    ...
    Matching              = { bold = true, fg = col.yellow, underline = true },
...
add_with_prefix(colorscheme, "@org.", {
    ...
    ["agenda.scheduled"]      = { fg = pal.fg0 },
    ["agenda.scheduled_past"] = { fg = pal.fg0 },
    ["agenda.deadline"]       = { fg = col.red },
    ["agenda.weekend"]        = { fg = col.bright_gray },
    ["agenda.time_grid"]      = { fg = col.bright_gray },
